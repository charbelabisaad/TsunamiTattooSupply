	...
	public class RolesController : Controller
	{
		...
		try { 
			...
			if (ID != 0)
			{
				...
				existingRole.EditUserID = Convert.ToInt32(HttpContext.Request.Cookies["UserID"]);
		...
		public IActionResult DeleteRole (int ID)
		{
			...
			try { 
				...
				if (existingRole != null)
				{
					...
					existingRole.DeletedUserID = Convert.ToInt32(HttpContext.Request.Cookies["UserID"]);
